...
export const ui = {
  en: {
    "home.hero.title": "Hi, I'm Léo Hengebaert",
    "home.hero.tagline": "A Front-End Developer currently based in Paris",
    "home.hero.role1": "Web developer",
    "home.hero.role2": "Websites Creator",
    "home.hero.portrait-alt": "Portrait of Léo Hengebaert",
    ...
    "home.services.description":
      "Want me to build your website ? Select the offer you need",
    ...
    "about.img-alt": "Léo Hengebaert at work",
    ...
    "about.sections.education.content":
      "Web design training at CEFII (Center for Study and Training in Computer Science and Internet) - RNCP level 5",
    ...
    "about.sections.skills.professional.items": [
      ...
      "Teamwork: Experience working in agile teams with developers, designers, PO.",
      "Problem Solving: Ability to effectively solve technical problems.",
      "Creativity: Ability to bring creative ideas to projects.",
    ],
    "about.sections.skills.languages.title": "Languages:",
    "about.sections.skills.languages.items": [
  ...
  fr: {
    ...
    "home.services.description":
      "Vous voulez que je construise votre site web ? Sélectionnez l'offre dont vous avez besoin",
    ...
    "about.tagline":
      "Merci de votre visite. Découvrez ci-dessous mon parcours et mon expérience.",
    "about.img-alt": "Léo Hengebaert au travail",
    ...
    "about.sections.education.content":
      "Formation en web design au CEFII (Centre d'Étude et de Formation en Informatique et Internet) - Niveau RNCP 5",

    "about.sections.skills.title": "Mes Compétences",
    ...
    "about.sections.skills.professional.items": [
      "Gestion de projet : Agile/Scrum, gestion de sprint, estimation, revue, planification. Jira, Confluence, Slack.",
      "Travail d'équipe : Expérience de travail en équipes agiles avec développeurs, designers, PO.",
      "Résolution de problèmes : Capacité à résoudre efficacement les problèmes techniques.",
      "Créativité : Capacité à apporter des idées créatives aux projets.",
    ],
    "about.sections.skills.languages.title": "Langues :",
    "about.sections.skills.languages.items": [
