/* ──────────────────────────────────────────────────────────────────────────
   ...
   Mode : agence — vidéo desktop 16:9
   Spécificité par rapport à RWJ/Bald :
   - Hero = vidéo 16:9 full container (au lieu d'un screenshot)
   - Pas d'url client (module SCORM interne) → on enlève le bouton "Voir le site"
   - Section "Équipe" (credits) avant le CTA — pattern à généraliser
     pour les projets agence
   ────────────────────────────────────────────────────────────────────────── */
...
const STACK_DETAIL: { nom: string; role: string }[] = [
  { nom: "React + Vite",           role: "SPA statique · build autonome compatible SCORM" },
  { nom: "SCORM 1.2 (pipwerks)",   role: "Communication LMS · score · progression · complétion" },
  { nom: "PixiJS",                 role: "Mini-jeux canvas WebGL haute performance" },
  { nom: "react-beautiful-dnd",    role: "Drag & drop accessible · ARIA · navigation clavier" },
  { nom: "GSAP",                   role: "Timelines orchestrées texte · image · son" },
  { nom: "Framer Motion",          role: "Animations React des composants UI" },
  { nom: "Zustand",                role: "Machine à états du flow pédagogique (6 chapitres)" },
  { nom: "Storybook",              role: "Validation visuelle des composants en isolation" },
];
...
/* ════════════════════════════════════════════════════════════════════════
   PARSEUR DE TEXTE — copie locale alignée sur RWJ / Bald
   ════════════════════════════════════════════════════════════════════════ */
...
export default function BnpParibasPage() {
    ...
    <div className="pt-28 pb-28">
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-10 mb-12">
        ...
        <div className="grid lg:grid-cols-[1fr_320px] gap-12 items-start">
          ...
          <Reveal duration={0.55} y={18} delay={0.12} className="space-y-3 lg:pt-2 hidden sm:block">
            ...
            >
              <div>
                <p className="text-[10px] uppercase tracking-[0.25em] mb-2 font-semibold" style={{ color: "var(--lavender)" }}>
                  Client
                </p>
                <p className="text-sm font-semibold text-foreground">{projet.client}</p>
              </div>
              <div>
                <p className="text-[10px] uppercase tracking-[0.25em] mb-1.5 font-semibold" style={{ color: "var(--lavender)" }}>
                  Contexte
                </p>
            ...
            {/* Pas d'url client : on laisse l'espace respirer plutôt que d'afficher un encart. */}
          </Reveal>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-10 space-y-24 sm:space-y-32">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, transparent, hsl(284 24% 70% / 0.3) 40%, hsl(163 52% 76% / 0.2) 60%, transparent)",
          }}
        />

        {/* ──────────────────────────────────────────────────────────────
            01 — VUE D'ENSEMBLE
            Pas de tagline pour ce projet (les chiffres clés sont dans
            l'intro). Pattern : header label/contenu + vidéo 16:9 full
            container + descriptionPublic alignée sur la colonne contenu.
            ────────────────────────────────────────────────────────────── */}
              ...
              <div className="max-w-3xl">
                <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black tracking-[-0.02em] text-foreground leading-[1.1]">
                  ...
                  <em
                    ...
                    style={{ color: "var(--lavender)" }}
                  >
                    qui remplace Articulate
                  </em>
                  {" "}
                  par une app React.
                </h2>
                <p className="mt-5 text-base text-foreground/72 leading-relaxed">
                  6 chapitres, 5 mini-jeux, 6 vidéos générées par IA, un personnage guide,
                  packagé en SCORM 1.2 pour s&apos;intégrer dans le LMS interne BNP.
                </p>
              </div>
            </header>
          </Reveal>
            ...
            <Reveal delay={0.08} y={20} duration={0.65}>
              <figure className="space-y-3">
                ...
                <figcaption className="flex items-center justify-between text-[10px] font-mono uppercase tracking-[0.32em] text-foreground/40">
                  ...
                  <span>Module SCORM interne</span>
                </figcaption>
              </figure>
            </Reveal>
          )}
        ...
        {/* ──────────────────────────────────────────────────────────────
            ...
            Mini-jeux, puis récaps & résultats.
            ────────────────────────────────────────────────────────────── */}
            ...
            <Reveal>
              <header className="grid grid-cols-1 lg:grid-cols-[180px_1fr] gap-4 lg:gap-12 items-baseline">
                ...
                <div className="max-w-2xl">
                  ...
                  <p className="mt-5 text-base text-foreground/72 leading-relaxed">
                    Pour les développeurs et les recruteurs : voici les choix techniques
                    qui ont structuré ce module e-learning gamifié, du remplacement
                    d&apos;Articulate à l&apos;accessibilité au clavier.
                  </p>
                </div>
              </header>
            </Reveal>
        ...
        {/* ──────────────────────────────────────────────────────────────
            06 — ÉQUIPE (crédits) — pattern à généraliser pour les
            projets agence. Index typo simple : numéro · nom · rôle.
            ────────────────────────────────────────────────────────────── */}
        {credits.length > 0 && (
          <section className="space-y-10">
            <Reveal>
              <header className="grid grid-cols-1 lg:grid-cols-[180px_1fr] gap-4 lg:gap-12 items-baseline">
                ...
                <div className="max-w-2xl">
                  ...
                  <p className="mt-5 text-base text-foreground/72 leading-relaxed">
                    Le projet a été mené chez Artefact 3000, en collaboration étroite
                    avec une équipe design et un manager produit.
                  </p>
                </div>
              </header>
            </Reveal>
        ...
        <Reveal delay={0.05}>
          ...
          >
            <div>
              ...
              <p className="text-base font-bold text-foreground group-hover:text-(--lavender) transition-colors">
